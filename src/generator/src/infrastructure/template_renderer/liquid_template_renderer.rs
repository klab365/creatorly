...
use templatespecification::core::template_specification::{TemplateSpecification, TemplateSpecificationItem};
...
fn map_to_liquid_object(value: TemplateSpecification) -> liquid::Object {
    ...
    let key = TemplateSpecificationItem::PREFIX.to_string();
...
#[cfg(test)]
mod tests {
    use templatespecification::core::template_specification::TemplateSpecificationItemType;
